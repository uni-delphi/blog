      ...
      <main>
        <section>
          <div className="container mx-auto mt-12 md:mt-16">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6 bg-black p-10">
        ...
        <section>
          <div className="container mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6 p-10">
                ...
                return (
                  <ArticleHomeCard key={article.id} style="h-full bg-white col-span-2 overflow-hidden text-black hover:border-[var(--magenta)] hover:text-[var(--magenta)] transition-all duration-300 ease-in-out">
                    <article className="col-span-2 block">
                      ...
                      >
                        <div className="w-2/5 md:w-5/5 font-serif w-full">
                        ...
                        <div className="w-5/5 py-4 flex flex-col gap-4 font-serif w-full mb-4 border-b border-[#ec1c90]">
                          <h2 className="text-lg lg:text-2xl font-semibold text-black leading-tight text-balance">
                            {article.titulo}
                          </h2>
                          <p className="text-sm text-black font-light leading-snug text-balance">
                            {article.bajada}
                          </p>
                          {/* <ArticleDate
