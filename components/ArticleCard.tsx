...
export default function ArticleCard({ article }: any) {
  ...
  return (
    <article className="col-span-1 block">
      <Link
        href={`/${article.slug}`}
      ...
      >
        ...
        <div className="w-3/5 md:w-5/5 py-4 flex flex-col gap-4 font-serif w-full">
          <h2 className="text-lg lg:text-2xl font-semibold text-gray-200 leading-tight text-balance">
            {article.titulo}
          </h2>
